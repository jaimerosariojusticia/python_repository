...
#===============================================================#
COMMAND = 'show cable flap-list sort-time'
...
time.sleep(3)
output = remote_conn.recv(65535)
output = output.decode().replace(COMMAND,'').replace('bsr#','')

output = output.replace('MAC ID         CableIF Hit   Miss  Ins  Pow  Rng  Flap  Type Time', "\033[0;30;43m" + 'MAC ID         CableIF HIT   MISS  INS  POW  RNG  FLAP  TYPE TIME' + "\033[0;37;39m")

output = output.replace('Ins', "\033[1;37;41m" + 'Ins' + "\033[0;37;39m")
output = output.replace('PAdj', "\033[1;36;40m" + 'PAdj' + "\033[0;37;39m")
output = output.replace('Rng', "\033[1;37;41m" + 'Rng' + "\033[0;37;39m")
output = output.replace('99999', "\033[1;31;40m" + '99999' + "\033[0;37;39m")
